...
<video autoplay="true" muted="true" loop="true" preload="auto" style="width: 100%; height: auto;">
    <source src="/images/video/index_video.mp4" type="video/mp4">
    <source src="/images/video/index_video.ogv" type="video/ogv">
</video>
<div class="index_banner"><img src="/images/video/index_video.jpg" style="width: 100%"></div>
<div class="index-list">
    @foreach($product as $data)
    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
        <div class="hover ehover13">
            <a href="/product/detail/{{ $data->layer1 }}/{{ $data->id }}">
